...
class TestDependencies(unittest.TestCase):
    def testAddPackage(self):
        ...
        #print '-------------------------- EXPORTS ----------------------- ', deps.exports
        #print '-------------------------- SRC ----------------------- ', deps.src
        #print '-------------------------- BUNDLES ----------------------- ', deps.bundles
        #print '-------------------------- TARGET  ----------------------- ', deps.target_platform
        ...
        for bundle in deps.bundles:
            ...
            for exports in bundle:
                print exports.name
            for imports in bundle:
                print imports.name
            for rbundles in bundle.rbundles:
                print rbundles.name
